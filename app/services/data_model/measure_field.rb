...
class DataModel::MeasureField
  ...
  attr_reader :field_name, :data_type, :default_operator, :allow_operator, :custom_sql_node

  def initialize(field_name, data_type, default_operator: nil, except_operators: nil, allow_operators: true, sql: nil)
