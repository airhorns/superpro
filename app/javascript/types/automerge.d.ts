...
declare module "automerge" {
  ...
  class Table<T, KeyOrder extends (keyof T)[]> {
...
type KeyArray<T, KeyOrder extends (keyof T)[]> = keyof T extends KeyOrder[number] ? KeyOrder : Exclude<keyof T, KeyOrder[number]>[];
...
// ```
type TupleFromInterface<T, KeyOrder extends (keyof T)[]> = { [I in keyof KeyOrder]: Lookup<T, KeyOrder[I]> };
