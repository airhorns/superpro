...
export interface AppMutationUpdateBudgetArgs {
  budgetId: Scalars["ID"];
...
export interface AppQueryBudgetArgs {
  budgetId: Scalars["ID"];
}
...
export interface BudgetAttributes {
  ...
  budgetLines: BudgetLineAttributes[];
}
...
export interface BudgetLine {
  ...
  discardedAt: Scalars["ISO8601DateTime"];
  id: Scalars["ID"];
  recurrenceRules: Scalars["RecurrenceRuleString"][];
  section: Scalars["String"];
  sortOrder: Scalars["Int"];
  updatedAt: Scalars["ISO8601DateTime"];
}

export interface BudgetLineAttributes {
  /** An opaque identifier that will appear on objects created/updated because of
   * this attributes hash, or on errors from it being invalid.
   */
  mutationClientId?: Maybe<Scalars["MutationClientId"]>;
  ...
  description: Scalars["String"];
  section: Scalars["String"];
  recurrenceRules?: Maybe<Scalars["RecurrenceRuleString"][]>;
  sortOrder: Scalars["Int"];
  amountScenarios: Scalars["JSONScalar"];
}
...
export interface GetBudgetForEditQueryVariables {
  budgetId: Scalars["ID"];
}
...
export type GetBudgetForEditQuery = { __typename?: "AppQuery" } & {
  budget: Maybe<
    { __typename?: "Budget" } & Pick<Budget, "id" | "name"> & {
        budgetLines: ({ __typename?: "BudgetLine" } & Pick<
            BudgetLine,
...
export interface UpdateBudgetMutationVariables {
  budgetId: Scalars["ID"];
  budget: BudgetAttributes;
}
...
export type UpdateBudgetMutation = { __typename?: "AppMutation" } & {
  updateBudget: Maybe<
    { __typename?: "UpdateBudgetPayload" } & {
      ...
      >;
      errors: Maybe<({ __typename?: "MutationError" } & Pick<MutationError, "field" | "fullMessage">)[]>;
    }
  >;
};

export interface SiderInfoQueryVariables {}
