...
export type ReportBuilderPageQuery = { __typename: "AppQuery" } & WarehouseIntrospectionForWarehouseFragment;

export type WarehouseIntrospectionForWarehouseFragment = { __typename: "AppQuery" } & {
...
export type GetWarehouseGlobalFilterOptionsQuery = { __typename: "AppQuery" } & {
  warehouseIntrospection: { __typename: "WarehouseIntrospection" } & {
    factTables: Array<
      { __typename: "WarehouseIntrospectionFactTable" } & Pick<WarehouseIntrospectionFactTable, "name"> & {
          globalFilterFields: Array<
            { __typename: "WarehouseIntrospectionGlobalFilterField" } & Pick<WarehouseIntrospectionGlobalFilterField, "id" | "field">
          >;
        }
    >;
    operators: Array<{ __typename: "WarehouseIntrospectionOperator" } & Pick<WarehouseIntrospectionOperator, "key">>;
  };
  currentAccount: { __typename: "Account" } & Pick<Account, "id"> & {
      businessLines: Array<{ __typename: "BusinessLine" } & Pick<BusinessLine, "id" | "name">>;
    };
};
...
`;
export type GetWarehouseGlobalFilterOptionsComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<GetWarehouseGlobalFilterOptionsQuery, GetWarehouseGlobalFilterOptionsQueryVariables>,
  "query"
>;

export const GetWarehouseGlobalFilterOptionsComponent = (props: GetWarehouseGlobalFilterOptionsComponentProps) => (
  <ApolloReactComponents.Query<GetWarehouseGlobalFilterOptionsQuery, GetWarehouseGlobalFilterOptionsQueryVariables>
    query={GetWarehouseGlobalFilterOptionsDocument}
    {...props}
  />
);
 ...
 * });
 */
export function useGetWarehouseGlobalFilterOptionsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<GetWarehouseGlobalFilterOptionsQuery, GetWarehouseGlobalFilterOptionsQueryVariables>
) {
  return ApolloReactHooks.useQuery<GetWarehouseGlobalFilterOptionsQuery, GetWarehouseGlobalFilterOptionsQueryVariables>(
    GetWarehouseGlobalFilterOptionsDocument,
    baseOptions
  );
}
export function useGetWarehouseGlobalFilterOptionsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetWarehouseGlobalFilterOptionsQuery, GetWarehouseGlobalFilterOptionsQueryVariables>
) {
  return ApolloReactHooks.useLazyQuery<GetWarehouseGlobalFilterOptionsQuery, GetWarehouseGlobalFilterOptionsQueryVariables>(
    GetWarehouseGlobalFilterOptionsDocument,
    baseOptions
  );
}
...
export type GetWarehouseGlobalFilterOptionsQueryResult = ApolloReactCommon.QueryResult<
  GetWarehouseGlobalFilterOptionsQuery,
  GetWarehouseGlobalFilterOptionsQueryVariables
>;
